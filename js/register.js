...
function SignUp() {
  ...
  valid =
    valid &
    kiemTraDuLieuRong(arrIdInput, arrIdNotiInput, nguoiDung) &
    kiemTraEmail(nguoiDung.email, "tbEmail") &
    kiemTraPass(nguoiDung.password, "tbPassword") &
    kiemTraPassConfirm(
      nguoiDung.passwordConfirm,
      nguoiDung.password,
      "tbPasswordConfirm"
    ) &
    kiemTraName(nguoiDung.name, "tbName") &
    kiemTraPhone(nguoiDung.phone, "tbPhone");
